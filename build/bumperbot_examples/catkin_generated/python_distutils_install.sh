...
echo_and_run cd "/home/ahmed/bumperbot_ws/src/bumperbot_examples"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ahmed/bumperbot_ws/src/bumperbot_examples/setup.py" \
     \
    build --build-base "/home/ahmed/bumperbot_ws/build/bumperbot_examples" \
    install \
    --root="${DESTDIR-/}" \
