...
echo_and_run cd "/home/ahmed/bumperbot_ws/src/bumperbot_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ahmed/bumperbot_ws/src/bumperbot_utils/setup.py" \
     \
    build --build-base "/home/ahmed/bumperbot_ws/build/bumperbot_utils" \
    install \
    --root="${DESTDIR-/}" \
